...
/*
Be forewarned that this is a high risk investment. 
Our smart contract has not been audited, so “ape in” at your own risk. 
By purchasing SPEECH token you agree that you are not purchasing a security or investment and you agree to hold the FreeSpeech.
Finance team and its associates harmless and not liable for any losses, 
taxes or legal sanctions you may incur. 
You also agree the team is presenting the token “as is” and is not required to provide you any support or services. 
Always do your own due diligence before making any investment decisions. The SPEECH token is merely a token for social experiment purposes and is not a digital currency.
...
contract FreeSpeech is Context, IERC20, Ownable {
    ...
    string private _name = "FreeSpeech.Finance";
    string private _symbol = "SPEECH";
    ...
    address payable public charityAddress = 0xE00bAf27d2d96bC9CefA9a302E33e1fC5E0786E6; // Charity Address
